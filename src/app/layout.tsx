    ...
    <div style={{ width: '131px', height: '32px', color: fillColor }} className="flex items-center justify-center">
      ...
      >
        <text
          ...
          fontSize="20" // Adjusted font size to better fit
          fontWeight="bold"
          textAnchor="middle"
          dominantBaseline="middle"
        // fill is inherited from parent SVG if not specified here
        >
          PROLTER
        </text>
      </svg>
...
// REMOVED THE FIRST, SIMPLER RootLayout definition that was causing the duplicate export error.
...
function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-screen"> {/* Outer container for vertical stacking of header and main content */}
      {!isMapPage && <AppHeader onToggleSidebar={toggleMobileSidebar} />} {/* Header is always on top */}
      
      <div className="flex flex-1 overflow-hidden"> {/* Container for sidebar and main content area to sit side-by-side */}
        <Sidebar>
          <SidebarHeader>
        ...
        {/* Main content area, now takes remaining width and has vertical flex for header and content */}
