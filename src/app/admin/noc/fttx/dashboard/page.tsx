// src/app/admin/noc/fttx/dashboard/page.tsx
'use client';
...
export default function FTTxDashboardPage() {
  ...
  const lightLevelIconSize = "h-3 w-3"; 
          ...
          {fttxDashboardData.olts.length > 0 ? (
                ...
                <Card key={olt.id} className="flex flex-col">
                  ...
                  <CardFooter className="pt-2">
                    <Button variant="outline" size="sm" className="w-full text-xs" asChild>
                        <Link href={`/admin/noc/fttx/olts/${olt.id}`}>{t('fttx_dashboard.olt_view_details', 'View Details')}</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
           ...
           <div className="mt-4 text-right">
            <Button variant="link" size="sm" asChild className="text-xs">
                <Link href="/admin/noc/fttx/olts">{t('fttx_dashboard.view_all_olts_button')}</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
             ...
             <div className="mt-4 text-right">
               <Button variant="link" size="sm" asChild className="text-xs">
                  <Link href="/admin/noc/fttx/olts?tab=onxs">{t('fttx_dashboard.view_all_onxs_button', 'View All ONXs')}</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              {fttxDashboardData.onxLightLevels.map(level => {
                ...
                return (
                  <Link
                    key={level.range}
                    href={`/admin/noc/fttx/olts?tab=onxs&lightLevelFilter=${encodeURIComponent(level.range)}`}
