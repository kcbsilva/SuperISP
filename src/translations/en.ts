...
const en = {
  ...
  messenger_flow: {
    title: 'Manage Messenger Flows', // Generic title for the page
    description: 'Define and manage automated conversation flows for your messenger bot.',
    add_new_flow_button: 'Add New Flow',
    add_new_flow_toast_title: 'Add New Flow (Not Implemented)',
    add_new_flow_toast_desc: 'Functionality to add a new flow is not yet implemented.',
    list_title: 'Configured Flows',
    list_description: 'Manage your automated messenger flows and their statuses.',
    table_header_description: 'Description',
    table_header_status: 'Status',
