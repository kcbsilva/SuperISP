...
const en = {
  ...
  messenger_chat: {
    ...
    chat_interface_description: 'Interact with your messenger bot and view conversations.',
    bot_greeting: 'Hello! How can I help you today?',
    user_example_query: 'I need help with my internet plan.',
    placeholder: 'Messenger chat interface will be here.',
    type_message_placeholder: 'Type your message...',
    send_button_sr: 'Send',
  },
  messenger_departments: {
    title: 'Manage Messenger Departments',
    description: 'Define departments for routing conversations and assigning agents.',
  ...
  messenger_configure: {
    ...
    description: 'Set up your AI-powered messenger bot, connect to platforms, and define behaviors.',
    ...
    ai_settings_placeholder: 'Configure Genkit flows, prompts, and automated responses. (Not Implemented)',
