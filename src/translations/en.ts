...
const en = {
  ...
  dashboard: {
   ...
   maps_elements: {
    ...
    cash_book: {
      ...
      add_success_description: 'Entry of type {type} "{description}" added.',
  ...
  messenger_flow: {
    ...
    description: 'Define and manage Genkit flows for your messenger bot using a visual editor.',
    add_step_button: 'Add Step',
    apply_changes_button: 'Apply Changes',
    edit_step_title: 'Edit Flow Step',
    edit_step_desc: 'Modify the message and options for the selected flow step.',
    select_step_label: 'Current Step',
    delete_step_button_tooltip: 'Delete selected step',
    message_label: 'Message',
    message_placeholder: 'Enter the message the bot will send for this step...',
    options_label: 'Options (User Responses)',
    keyword_placeholder: 'Keyword',
    next_step_placeholder: 'Next Step ID',
    delete_option_button_tooltip: 'Delete this option',
    add_option_button: 'Add Option',
    visualization_title: 'Flow Visualization',
    visualization_desc: 'Visual representation of your messenger flow. Click nodes to select for editing.',
    loading_flow: 'Loading flow configuration...',
    no_steps_placeholder: 'No flow steps defined yet. Click "Add Step" to begin.',
    unsaved_changes_indicator: 'Unsaved Changes',
    save_success_title: 'Flow Saved',
    save_success_desc: 'Messenger flow configuration has been updated.',
    prompt_new_step_key: 'Enter a unique key for the new flow step (e.g., support_internet):',
    error_step_key_title: 'Invalid Step Key',
    error_step_key_exists_desc: 'A step with this key already exists.',
    error_step_key_invalid_desc: 'Please enter a valid key for the new step.',
    new_step_default_message: 'New step message. Please edit.',
    error_delete_step_title: 'Cannot Delete Step',
    error_delete_step_desc: 'Cannot delete the last remaining step in the flow.',
