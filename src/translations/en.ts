...
const en = {
  ...
  pops: {
   ...
   maps_elements: {
    ...
    fdh_template_modal_not_implemented_desc: 'Managing templates for FDHs is not yet available.',
    ...
    poll_template_form_heights_label: 'Height Options (comma-separated)',
    poll_template_form_heights_placeholder: 'e.g., 9m, 10.5m, 12m',
    poll_template_form_strength_label: 'Strength Class',
    poll_template_form_strength_placeholder: 'e.g., Class 5, 300daN',
    ...
    poll_template_add_success_desc: 'Template by {manufacturer} for {material} polls added.',
    existing_poll_templates_list_title: 'Existing Templates',
    no_existing_poll_templates: 'No existing templates.',
    poll_template_info_heights: 'Heights',
    poll_template_info_strength: 'Strength',
  },
    settings_plans: {
