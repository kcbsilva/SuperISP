...
const en = {
  ...
  new_contract_wizard: {
    ...
    add_service_modal_desc: 'Select the service type, technology (if applicable), and plan.',
  ...
  financial_configs: {
    ...
    billing_dates_description: 'Manage the billing cycle dates for your services.',
    table_header_date: 'Date',
    table_header_active_contracts: 'Active Contracts',
    table_header_status: 'Status',
    table_header_actions: 'Actions',
    action_delete: 'Delete',
    no_billing_dates: 'No billing dates configured yet.',
    add_date_button: 'Add Date',
    add_date_modal_title: 'Add New Billing Date',
    add_date_modal_description: 'Configure a new date for billing cycles and assign permitted PoPs.',
    form_date_label: 'Date',
    form_date_placeholder: 'Select a date',
    form_status_label: 'Status',
    form_status_active_desc: 'This billing date is active.',
    form_status_inactive_desc: 'This billing date is inactive.',
    ...
    form_cancel_button: 'Cancel',
    form_save_button: 'Save Date',
    add_date_success_title: 'Billing Date Added',
    add_date_success_description: 'Billing date {date} added.',
    delete_date_success_title: 'Billing Date Deleted',
    delete_date_success_description: 'Billing date {date} deleted.',
    delete_confirm_title: 'Are you sure?',
    delete_confirm_description: 'This will permanently delete the billing date {date}.',
    delete_confirm_cancel: 'Cancel',
    delete_confirm_delete: 'Delete',
    status_active: 'Active',
    status_inactive: 'Inactive',
    toggle_status_aria_label: 'Toggle billing date status',
    status_change_toast_title: 'Status Updated',
    status_change_toast_description: 'Billing date status has been updated.',
  },
};
