  ...
  pops: {
   ...
   maps_elements: {
    ...
    financial_configs: {
        ...
        status_change_toast_description: 'Billing day status has been changed.',
    ...
    new_contract_wizard: {
      ...
      step1_saved_desc: 'Contract general information has been saved. Proceed to add services.',
      ...
      no_plans_available: 'No plans available for selected criteria.',
      add_to_contract_button: 'Add to Contract',
      service_added_to_contract_title: 'Service Added',
      service_added_to_contract_desc: '{planName} added to the contract.',
    ...
    settings_users: {
        ...
        delete_template_confirm_desc: 'Are you sure you want to delete the template "{name}"? This action is irreversible.',
    ...
    service_calls: {
      ...
      view_call_not_implemented_desc: 'Viewing details for service call {id} is not yet available.',
