...
const pt = {
  ...
  dashboard: {
   ...
   maps_elements: {
    ...
    list_title_foscs: 'Lista de CEOs', // Corrected to FOSCs for Portuguese
    no_foscs_found: 'Nenhuma CEO encontrada. Clique em "Adicionar CEO" para criar uma.', // Corrected to FOSCs for Portuguese
    ...
    fosc_template_modal_title: 'Adicionar Novo Modelo de CEO',
    fosc_template_modal_desc: 'Definir um novo modelo para tipos de CEO.',
