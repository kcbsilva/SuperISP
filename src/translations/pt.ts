   ...
   maps_page: {
    ...
    onx_templates: {
     ...
     fttx_olts: {
      ...
      table_header_slots: 'Placas', // Added
      table_header_ports: 'Portas PON', // Clarified
      table_header_onxs: 'ONXs (Conectadas / Máx)', // Changed from Clients
      table_header_ip_address: 'Endereço IP',
      table_header_actions: 'Ações',
      action_edit: 'Editar',
      action_delete: 'Excluir',
      no_olts_found: 'Nenhuma OLT registrada ainda. Clique em "Adicionar OLT" para criar uma.',
      add_olt_not_implemented_title: 'Adicionar OLT (Não implementado)',
      add_olt_not_implemented_desc_port: 'A funcionalidade para adicionar novas OLTs (incluindo porta de gerenciamento) ainda não está disponível.',
      add_onx_not_implemented_title: 'Adicionar ONx (Não implementado)',
      add_onx_not_implemented_desc: 'A funcionalidade para adicionar novos dispositivos ONx ainda não está disponível.',
      edit_olt_not_implemented_title: 'Editar OLT (Não implementado)',
      edit_olt_not_implemented_desc: 'A edição da OLT {id} ainda não está disponível.',
      delete_olt_not_implemented_title: 'Excluir OLT (Não implementado)',
      delete_olt_not_implemented_desc: 'A exclusão da OLT {id} ainda não está disponível.',
      olt_actions_menu: 'Ações OLT',
      list_non_provisioned_onxs: 'Listar ONXs Não Provisionadas',
      list_provisioned_onxs: 'Listar ONXs Provisionadas',
      list_onxs_title_provisioned: 'Listar ONXs Provisionadas (Não implementado)',
      list_onxs_desc_provisioned: 'A listagem de ONXs provisionadas para a OLT {id} ainda não está disponível.',
      list_onxs_title_non_provisioned: 'Listar ONXs Não Provisionadas (Não implementado)',
      list_onxs_desc_non_provisioned: 'A listagem de ONXs não provisionadas para a OLT {id} ainda não está disponível.',
    ...
    new_contract_wizard: {
      ...
      billing_type_placeholder: 'Selecione o tipo de cobrança',
    ...
    financial_configs: {
      ...
      form_no_selected_pops: 'Nenhum PoP permitido para l\'instant.',
      form_cancel_button: 'Cancelar',
