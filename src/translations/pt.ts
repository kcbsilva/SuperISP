  ...
  dashboard: {
   ...
   maps_page: {
    ...
    settings_users: {
      ...
      delete_template_toast_title: 'Template Excluído',
    ...
    postgresql_page: {
      ...
      select_option_prompt: 'Por favor, selecione uma opção na barra lateral para gerenciar bancos de dados ou tabelas PostgreSQL, ou use o CLI.',
      databases_title: 'Bancos de Dados',
      databases_list_title: 'Lista de Bancos de Dados',
      databases_list_description: 'Visualizar e gerenciar seus bancos de dados PostgreSQL.',
      db_header_name: 'Nome',
      ...
      add_database_dialog_description: 'Insira o nome para o novo banco de dados PostgreSQL.',
      form_db_name_label: 'Nome do Banco de Dados',
      form_db_name_placeholder: 'ex: meu_novo_app_db',
      ...
      no_databases_found: 'Nenhum banco de dados encontrado ou impossível conectar. Verifique seu arquivo .env e assegure que o servidor de banco de dados está acessível.',
      ...
      select_database_prompt: 'Por favor, selecione um banco de dados para visualizar suas tabelas.',
      backup_restore_title: 'Backup & Restauração',
      backup_restore_description: 'Gerencie backups de banco de dados e operações de restauração.',
      ...
      cli_simulated_error_desc: 'Erro simulado ao executar comando: Sintaxe inválida próximo a "error".',
      cli_execution_error_title: 'Erro na Execução',
      ...
      cli_command_success_no_output: 'Comando executado com sucesso, mas nenhum resultado específico foi retornado.',
    ...
    fttx_dashboard: {
      ...
      onx_status_title: "Visão Geral do Status das ONXs",
      onx_status_desc: "Resumo dos status das Unidades/Terminais de Rede Óptica.",
      ...
      onxs_non_provisioned: "ONXs Não Provisionadas",
      view_all_olts_button: "Ver Todas as OLTs",
      view_all_onxs_button: "Ver Todas as ONXs (Não Implementado)",
