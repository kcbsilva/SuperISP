  ...
  dashboard: {
   ...
   maps_page: {
    ...
    onu_templates: {
      ...
      confirm_delete_description: 'Esta ação não pode ser desfeita. Isso excluirá permanentemente o modelo "{name}".',
    ...
    financial_configs: {
      ...
      table_header_actions: 'Ações',
      action_delete: 'Excluir',
      no_billing_dates: 'Nenhuma data de faturamento configurada.',
      add_date_button: 'Adicionar Data',
      add_date_modal_title: 'Adicionar Nova Data de Faturamento',
      add_date_modal_description: 'Configure uma nova data para os ciclos de faturamento e atribua os PoPs permitidos.',
      form_date_label: 'Data',
      form_date_placeholder: 'Selecione uma data',
      form_status_label: 'Status',
      form_status_active_desc: 'Esta data de faturamento está ativa.',
      form_status_inactive_desc: 'Esta data de faturamento está inativa.',
      ...
      form_cancel_button: 'Cancelar',
      form_save_button: 'Salvar Data',
      add_date_success_title: 'Data de Faturamento Adicionada',
      add_date_success_description: 'Data de faturamento {date} adicionada.',
      delete_date_success_title: 'Data de Faturamento Excluída',
      delete_date_success_description: 'Data de faturamento {date} excluída.',
      delete_confirm_title: 'Tem certeza?',
      delete_confirm_description: 'Isso excluirá permanentemente a data de faturamento {date}.',
      delete_confirm_cancel: 'Cancelar',
      delete_confirm_delete: 'Excluir',
      status_active: 'Ativo',
      status_inactive: 'Inativo',
