  ...
  dashboard: {
   ...
   maps_page: {
    ...
    postgresql_page: { // Added
      ...
      no_databases_found: 'O banco de dados especificado na sua configuração de ambiente (PGDATABASE) não foi encontrado ou PGDATABASE não está definido. Por favor, verifique seu arquivo .env e garanta que o banco de dados existe e está acessível.',
