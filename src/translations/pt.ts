  ...
  dashboard: {
   ...
   maps_page: {
    ...
    postgresql_page: { // Added
      ...
      tables_list_description: 'Visualizar e gerenciar tabelas no banco de dados selecionado.',
      table_header_name: 'Nome',
      ...
      view_data_button: 'Visualizar Dados',
      no_databases_found: 'Nenhum banco de dados encontrado ou conexão impossível.',
      loading_databases_error: 'Erro ao carregar bancos de dados: {message}',
