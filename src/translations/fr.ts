...
const fr = {
  ...
  pops: {
   ...
   maps_elements: {
    ...
    fosc_template_modal_title: 'Ajouter un Nouveau Modèle de CEO',
    fosc_template_modal_desc: 'Définir un nouveau modèle pour les types de CEO.',
    ...
    no_towers_found: 'Aucune tour trouvée. Cliquez sur "Ajouter Tour" pour en créer un.',
