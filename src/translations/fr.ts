...
const fr = {
  ...
  financial_configs: {
    ...
    form_selected_pops_label: 'PoPs Sélectionnés',
    form_pops_load_error: 'Erreur lors du chargement des PoPs.',
    form_no_available_pops: 'Plus de PoPs à ajouter.',
    form_no_selected_pops: 'Aucun PoP sélectionné.',
    form_add_pop_button_sr: 'Ajouter le PoP sélectionné à la liste de permitidos',
    form_remove_pop_button_sr: 'Retirer le PoP sélectionné de la liste de permitidos',
    form_cancel_button: 'Annuler',
