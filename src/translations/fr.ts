...
const fr = {
  ...
  fttx_olts: {
    ...
    onx_table_light_level: 'Niveau de Lumière',
  ...
  settings_users: {
    ...
    add_template_success_title: 'Template Adicionado',
    add_template_success_desc: 'Modelo de usuário "{name}" adicionado.',
    update_template_success_title: 'Template Atualizado',
  ...
  postgresql_page: {
    ...
    select_option_prompt: 'Veuillez sélectionner une option dans la barre latérale pour gérer les bases de données ou les tables PostgreSQL, ou utiliser le CLI.',
    databases_title: 'Bases de données',
    databases_list_title: 'Liste des Bases de Données',
    databases_list_description: 'Visualisez et gérez vos bases de données PostgreSQL.',
    db_header_name: 'Nom',
    ...
    no_databases_found: 'Aucune base de données trouvée ou impossible de se connecter. Veuillez vérifier votre fichier .env et vous assurer que le serveur de base de données est accessible.',
    ...
    select_database_prompt: 'Veuillez sélectionner une base de données pour afficher ses tables.',
    ...
    cli_command_success_no_output: 'Commande exécutée avec succès, mais aucun résultat spécifique n\'a été retourné.',
    cli_execution_success_title: 'Commande Exécutée',
    cli_execution_success_toast_desc: 'Commande SQL traitée.',
    cli_execution_success_no_output_toast_desc: 'Commande SQL traitée sans résultat spécifique.',
  },
  fttx_dashboard: {
