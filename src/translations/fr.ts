...
const fr = {
  ...
  financial_configs: {
    ...
    billing_dates_description: 'Gérez les dates de cycle de facturation pour vos services.',
    table_header_date: 'Date',
    table_header_active_contracts: 'Contrats Actifs',
    table_header_status: 'Statut',
    table_header_actions: 'Actions',
    action_delete: 'Supprimer',
    no_billing_dates: 'Aucune date de facturation configurée.',
    add_date_button: 'Ajouter Date',
    add_date_modal_title: 'Ajouter Nouvelle Date de Facturation',
    add_date_modal_description: 'Configurez une nouvelle date pour les cycles de facturation et attribuez les PoPs autorisés.',
    form_date_label: 'Date',
    form_date_placeholder: 'Sélectionnez une date',
    form_status_label: 'Statut',
    form_status_active_desc: 'Cette date de facturation est active.',
    form_status_inactive_desc: 'Cette date de facturation est inactive.',
    ...
    form_cancel_button: 'Annuler',
    form_save_button: 'Enregistrer Date',
    add_date_success_title: 'Date de Facturation Ajoutée',
    add_date_success_description: 'Date de facturation {date} ajoutée.',
    delete_date_success_title: 'Date de Facturation Supprimée',
    delete_date_success_description: 'Date de facturation {date} supprimée.',
    delete_confirm_title: 'Êtes-vous sûr ?',
    delete_confirm_description: 'Cela supprimera définitivement la date de facturation {date}.',
    delete_confirm_cancel: 'Annuler',
    delete_confirm_delete: 'Supprimer',
    status_active: 'Actif',
    status_inactive: 'Inactif',
    toggle_status_aria_label: 'Basculer le statut de la date de facturation',
    status_change_toast_title: 'Statut Mis à Jour',
    status_change_toast_description: 'Le statut de la date de facturation a été mis à jour.',
  },
};
